  ...
  return (
    <div className="bg-white">
          ...
          <AnimatePresence mode="wait">
            {filteredProducts.length === 0 ? (
              <motion.div 
                ...
                exit={{ opacity: 0, y: -20 }}
                className="py-40 text-center glass-futuristic rounded-[3rem] bg-gray-50/50"
              >
                ...
                {filteredProducts.map((product) => {
                  ...
                  return (
                    <StaggerItem 
                      key={product.id} 
                      className={cn(
                        "group bg-white p-10 rounded-[2.5rem] border border-gray-100 hover:border-red/20 hover:shadow-2xl transition-all duration-500 relative flex flex-col justify-between min-h-[520px] overflow-hidden"
                      )}
                    >
      ...
      <section className="py-40 relative overflow-hidden bg-blue">
        ...
        <FadeIn className="max-w-[1400px] mx-auto px-6 md:px-12 text-center space-y-12 relative z-10">
